...
NS_LOG_COMPONENT_DEFINE ("First_Study");
...
int main(int argc, char** argv) 
{
	...
	o_filename << "scratch/1st_Study_"<<"Distance="<<distance<<"m_"<<"Duration="<<duration<<"s_"<<"Run="<<run;
    ...
    positionAlloc->Add (Vector (distance, 0.0, 0.0)); //node 1 Sender node
	...
	GlobalValue::Bind ("ChecksumEnabled", BooleanValue (false)); //to speed up simulation. Checksum should be enabled when using emulation	
